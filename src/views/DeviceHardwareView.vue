    ...
    <div class="container">
        ...
        <form @submit.prevent="save" class="needs-validation" novalidate>
            <div class="row">
                ...
                <div class="col-md-4">
                    <BsInputRadio v-model="config.ble_active_scan" :options="bleScanOptions" label="Scan Mode"
                ...
                <div class="col-md-12">
                    ...
                    <p>Supporting the following GravityMon BLE transmission options:
                        ...
                        <li>GravityMon EddyStone (Require BLE 5.0 board, for example esp32 S3)</li>
                    </p>
